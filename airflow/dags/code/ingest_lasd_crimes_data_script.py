...
def ingest_crimes_data_to_postgres(input, source_file, database, schema, table, user, password, host, port):
    ...
    lasd_crimes.to_sql(table, schema = schema, con = engine, if_exists = 'append', index = False)
